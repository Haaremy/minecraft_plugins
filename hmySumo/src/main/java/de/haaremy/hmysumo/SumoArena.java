...
public class SumoArena {
    ...
    public SumoArena(HmySumo plugin) {
        this.plugin = plugin;
    ...
    private void loadArenas() {
        ...
        plugin.getLogger().info(arenas.size() + " Sumo-Arena(s) geladen.");
    }

    public void saveArena(String name, Location spawn1, Location spawn2) {
        // Bestehende Arena mit gleichem Namen entfernen
    ...
    /**
     * Gibt eine freie Arena zurueck, oder null wenn keine verfuegbar.
     */
    ...
    /**
     * Datenklasse fuer eine einzelne Arena.
     */
